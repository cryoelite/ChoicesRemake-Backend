...
namespace DiffMatchPatch
{
    ...
    public class diff_match_patch
    {
        ...
        // How far to search for a match (0 = exact location, 1000+ = broad match). A match this
        // many characters away from the expected location will add 1.0 to the score (0.0 is a
        // perfect match).
        ...
        public List<Patch> patch_make(string text1, List<Diff> diffs)
        {
            ...
            int char_count2 = 0;  // Number of characters into the text2 string.
                                  // Start with text1 (prepatch_text) and apply the diffs until we
                                  // arrive at text2 (postpatch_text). We recreate the patches one
                                  // by one to determine context info.
                    ...
                    case Operation.EQUAL:
                        ...
                        if (aDiff.text.Length >= 2 * Patch_Margin)
                        {
                            ...
                            if (patch.diffs.Count != 0)
                            {
                                ...
                                // https://github.com/google/diff-match-patch/wiki/Unidiff Update
                                // prepatch text & pos to reflect the application of the just
                                // completed patch.
        ...
        protected int diff_commonOverlap(string text1, string text2)
        {
            ...
            // found. Performance analysis: https://neil.fraser.name/news/2010/11/04/
            int best = 0;
            int length = 1;
            while (true)
            {
